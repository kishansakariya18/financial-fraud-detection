...
export const apiConfig = {
  ...
  endPoints: {
    ...
    USER: {
      ...
      CHANGE_MANAGE_FUND_PASSWORD: '/config/admin/config/user/change-manage-fund-password'
    },
    ADMIN_USER: {
    ...
    AFFILIATE: {
      ...
      CHANGE_MANAGE_FUND_PASSWORD: '/config/admin/config/affiliate/change-manage-fund-password'
    },
    SETTINGS: {
      USER_KYC: {
