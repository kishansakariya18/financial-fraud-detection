  ...
  return (
    <>
      <Button
        ...
        <SettingIcon className="size-6 animate-spin" style={{ animationDuration: '2s' }} />
      </Button>
      ...
      <Transition show={isOpen}>
        <Dialog open={true} onClose={close} static autoFocus>
          ...
          <TransitionChild
            ...
            className="fixed inset-y-0 right-0 z-[61] flex w-screen transform-gpu flex-col bg-white backdrop-blur transition-transform duration-200 dark:bg-dark-750/80 sm:inset-y-2 sm:mx-2 sm:w-80 sm:rounded-xl">
  ...
  return (
    <>
      ...
      <ScrollShadow
        ...
        <RadioGroup value={theme.themeMode} onChange={theme.setThemeMode} className="mt-1">
          <Label className="font-medium text-gray-800 dark:text-dark-100">Theme Mode</Label>
              ...
              {({ checked }) => (
                <>
                  <div
                    ...
                    <div className="flex h-24 w-[30%] flex-col justify-between bg-gray-200 px-1 py-1.5 dark:bg-dark-700">
        ...
        <RadioGroup
          ...
          className="mt-5">
          <Label className="font-medium text-gray-800 dark:text-dark-100">Primary Colors</Label>
              ...
              <Radio
                ...
                className={({ checked }) =>
                  clsx(
                    ...
                    checked ? 'border-primary-500' : 'border-gray-200 dark:border-dark-500'
                  )
                }>
                {({ checked }) => (
                  <div
        ...
        <RadioGroup
          ...
          className="mt-5">
          <Label className="font-medium text-gray-800 dark:text-dark-100">Light Colors</Label>
          <div className="mt-2.5 grid grid-cols-3 gap-2.5">
            {lightColors.map((color) => (
              <Radio key={color} value={color} className="cursor-pointer outline-none">
                {({ checked }) => (
                  <>
                    <Placeholder
                      checked={checked}
                    ...
                    />
                    <p className="mt-1.5 text-center text-xs+ capitalize">{color}</p>
                  </>
                )}
              </Radio>
            ))}
        ...
        <RadioGroup
          ...
          className="mt-5">
          <Label className="font-medium text-gray-800 dark:text-dark-100">Dark Colors</Label>
          <div className="mt-2.5 grid grid-cols-3 gap-2.5">
...
function Placeholder({ bg, card, content, checked }) {
  return (
    <div
      ...
      <div className="w-full space-y-2 p-1 rtl:space-x-reverse" style={{ backgroundColor: bg }}>
        <div
          className="w-full space-y-2 rounded p-1 shadow-sm"
          style={{
