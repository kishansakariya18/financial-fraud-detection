...
import { DocumentTextIcon, FilmIcon, MusicalNoteIcon, PhotoIcon } from '@heroicons/react/24/solid';
    ...
    <div
      ...
      <div className="mr-2 flex min-w-0 items-center space-x-2 rtl:space-x-reverse">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 text-xs text-gray-400 dark:text-dark-300">{formatBytes(size)}</p>
        </div>
      </div>
      <Button onClick={handleRemove} variant="flat" className="-mr-1 size-7 shrink-0 p-0">
