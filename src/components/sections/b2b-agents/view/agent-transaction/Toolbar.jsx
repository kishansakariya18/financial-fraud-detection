...
import { creditDebitTypeOptions, agentTransactionTypeOptions } from '../../helper';
...
//   return (
//     <Input
//       value={table?.getColumn('referenceID')?.getFilterValue() || ''}
//       onChange={(e) => table.getColumn('referenceID').setFilterValue(e.target.value)}
//       onKeyDown={(e) => {
//         if (e.key === 'Enter') {
//           onApplyFilters();
//         }
...
//         root: 'shrink-0'
//       }}
//       placeholder={t('search') + ' ' + t('reference') + ' ID...'}
//     />
//   );
// }
...
function Filters({ table, onApplyFilters = () => {}, onClearFilters = () => {} }) {
  ...
  return (
    <>
      {table.getColumn('creditDebitType') && (
        <FacedtedFilter
          options={creditDebitTypeOptions}
          column={table.getColumn('creditDebitType')}
          title={t('credit') + '/' + t('debit')}
          Icon={FunnelIcon}
          isMultiple={false}
          showCheckbox={false}
        />
      ...
      {table.getColumn('transactionType') && (
        <FacedtedFilter
          options={agentTransactionTypeOptions}
