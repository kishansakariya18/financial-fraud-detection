...
const LastPlayersTable = ({ data = [], loading = false, onViewPlayer }) => {
  const { t } = useTranslation();
  const title = `${t('last')} ${data.length} ${t('players')}`;
...
export default LastPlayersTable;
