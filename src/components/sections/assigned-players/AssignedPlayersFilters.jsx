...
export function AssignedPlayersFilters({
  table,
  onApplyFilters = () => {},
  onClearFilters = () => {},
  pageTitle = '',
...
AssignedPlayersFilters.propTypes = {
  table: PropTypes.object.isRequired,
  onApplyFilters: PropTypes.func,
  onClearFilters: PropTypes.func,
  pageTitle: PropTypes.string,
  breadcrumbItem: PropTypes.array,
  onAddPlayers: PropTypes.func,
  canAddPlayers: PropTypes.bool,
