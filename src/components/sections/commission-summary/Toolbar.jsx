...
import { eventNameOptions, redeemFilterOptions, targetNameOptions } from './helper';
...
function Filters({ table, onApplyFilters = () => {}, onClearFilters = () => {} }) {
  ...
  return (
    <>
      {table.getColumn('targetName') && (
        <FacedtedFilter
          options={targetNameOptions}
          column={table.getColumn('targetName')}
          title={t('target_name')}
          Icon={MapPinIcon}
          isMultiple={false}
          showCheckbox={false}
      ...
      {table.getColumn('isRedeemed') && (
        <FacedtedFilter
          options={redeemFilterOptions}
          column={table.getColumn('isRedeemed')}
          title={t('redeem_status')}
          Icon={FunnelIcon}
          isMultiple={false}
          showCheckbox={false}
        />
