...
import PaymentProviderService from 'services/payment-provider.services';
...
export function RowActions({ row, table }) {
  ...
  const confirmMessages = {
    pending: {
      description: t('payment_provider_status_conf'),
      actionText: t('submit')
    },
    success: {
      title: t('payment_provider') + ' ' + t('status'),
      description: t('payment_provider_suceess')
    }
  };
