        ...
        <Menu as="div" className="relative inline-block text-left">
          ...
          <Transition
            ...
            <MenuItems
              ...
              {hasPermission(PERMISSIONS.RELEASE_NOTE.VIEW) && (
                <MenuItem>
                  {({ focus }) => (
                    <button
                      className={clsx(
              ...
              {hasPermission(PERMISSIONS.RELEASE_NOTE.EDIT) && (
                <MenuItem>
                  {({ focus }) => (
                    <button
                      className={clsx(
                      ...
                      onClick={() =>
                        navigate(`/release-notes/edit/${row.original.releaseNoteUID}`)
                      }>
              ...
              {hasPermission(PERMISSIONS.RELEASE_NOTE.CHANGE_STATUS) && (
                <MenuItem>
                  {({ focus }) => (
                    <button
              ...
              {hasPermission(PERMISSIONS.RELEASE_NOTE.DELETE) && (
                <MenuItem>
                  {({ focus }) => (
                    <button
