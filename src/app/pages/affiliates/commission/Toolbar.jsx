...
export function Toolbar({
  ...
  const handleExport = async () => {
    ...
    try {
      setIsExporting(true);
      const res = await AffiliatesService.exportCommissionSummaryReport({
        affiliateId,
      ...
      if (res.status === 200) {
        ...
        const ts = new Date()
          ...
          .replace('T', '_')
          .replace('Z', '');
        a.download = `commission-summary-${affiliateId}-${ts}.csv`;
  ...
  return (
    <div className="table-toolbar">
      <div
        ...
        {hasPermission(PERMISSIONS.AFFILIATES.REPORT?.COMMISSION_SUMMARY_EXPORT) && (
          <Button
            variant="outlined"
