...
export default function ViewDetails() {
  ...
  const pageTitle = t('responsible_gambling');

  const fetchDetails = useCallback(async () => {
    try {
      setLoading(true);
      const result = await ResponsibleGamblingService.detail(restrictionId);
      ...
      console.error('Error in fetchDetails (Responsible Gambling):', err);
  ...
  const breadcrumbItem = [
    { title: t('responsible_gambling'), path: '/responsible-gambling' },
    { title: t('details') }
  ];
