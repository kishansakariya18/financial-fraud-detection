...
export default function General() {
  ...
  return (
    <div className="w-full max-w-3xl 2xl:max-w-5xl">
      <h5 className="text-lg font-medium text-gray-800 dark:text-dark-50">General</h5>
      ...
      <div>
        <div>
          <p className="text-base font-medium text-gray-800 dark:text-dark-100">Linked Accounts</p>
          <p className="mt-0.5">Manage your linked accounts and their permissions.</p>
        </div>
        <div>
          <div className="mt-4 flex items-center justify-between space-x-2 rtl:space-x-reverse">
            <div className="flex min-w-0 items-center space-x-4 rtl:space-x-reverse">
              <div className="size-12">
                <img className="h-full w-full" src="/images/100x100.png" alt="logo" />
              </div>
              <p className="truncate font-medium">Sign In with Google</p>
            </div>
            <Button className="h-8 rounded-full px-3 text-xs+" variant="outlined">
              Connect
            </Button>
          </div>
          <div className="mt-4 flex items-center justify-between space-x-2 rtl:space-x-reverse">
            <div className="flex min-w-0 items-center space-x-4 rtl:space-x-reverse">
              <div className="size-12">
                <img className="h-full w-full" src="/100x100.png" alt="logo" />
              </div>
