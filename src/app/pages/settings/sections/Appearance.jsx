...
export default function Appearance() {
  ...
  return (
    <div className="w-full max-w-3xl 2xl:max-w-5xl">
      <h5 className="text-lg font-medium text-gray-800 dark:text-dark-50">Appearance</h5>
      <p className="mt-0.5 text-balance text-sm text-gray-500 dark:text-dark-200">
        Customize the appearance of the app. Select Theme colors and mode, to change the look of the
        app.
      </p>
      ...
      <div className="space-y-8">
        <div>
          <div>
            <p className="text-base font-medium text-gray-800 dark:text-dark-100">Theme</p>
            <p className="mt-0.5">You can select a theme color from the list below.</p>
          </div>
          <RadioGroup value={theme.themeMode} onChange={theme.setThemeMode} className="mt-4">
        ...
        <div>
          <div>
            <p className="text-base font-medium text-gray-800 dark:text-dark-100">Primary Color</p>
            <p className="mt-0.5">
        ...
        <div>
          <div>
            ...
            <p className="mt-0.5">Select light color scheme that will be used for your theme.</p>
          </div>
          <RadioGroup
            ...
            <div className="mt-2 flex flex-wrap gap-4">
              {lightColors.map((color) => (
                <Radio key={color} value={color} className="w-32 cursor-pointer outline-none">
                  {({ checked }) => (
                    <>
                      <div
                        className={clsx(
                        ...
                        <div
                          ...
                          <div className="w-full space-y-2 rounded bg-white p-2 shadow-sm">
                            <div
                              ...
                              style={{ backgroundColor: colors[color][400] }}></div>
                            <div
        ...
        <div>
          <div>
            ...
            <p className="mt-0.5">Select dark color scheme that will be used for your theme.</p>
          </div>
          <RadioGroup
      ...
      <div>
        <div>
          <p className="text-base font-medium text-gray-800 dark:text-dark-100">Notification</p>
          <p className="mt-0.5">
        ...
        <div className="mt-5 grid grid-cols-1 md:grid-cols-3">
          ...
          <Listbox
            ...
            value={notificationPos.find((pos) => pos.value === theme.notification?.position)}
