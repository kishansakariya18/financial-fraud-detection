              ...
              <>
                ...
                <Box className="rounded-lg bg-white px-4 py-4 shadow-soft dark:bg-dark-700 dark:shadow-none sm:px-5">
                  <div className="mt-1.5 flex items-center justify-between">
                    ...
                    <Switch
                      {...register('hasWeeklyDepositLimit')}
                      label=""
                      onClick={(e) => e.preventDefault()}
                      aria-disabled="true"
                    />
                ...
                <Box className="rounded-lg bg-white px-4 py-4 shadow-soft dark:bg-dark-700 dark:shadow-none sm:px-5">
                  <div className="mt-1.5 flex items-center justify-between">
                    ...
                    <Switch
                      {...register('hasMonthlyDepositLimit')}
                      label=""
                      onClick={(e) => e.preventDefault()}
                      aria-disabled="true"
                    />
                ...
                <Box className="rounded-lg bg-white px-4 py-4 shadow-soft dark:bg-dark-700 dark:shadow-none sm:px-5">
                  <div className="mt-1.5 flex items-center justify-between">
                    ...
                    <Switch
                      {...register('hasDailyWithdrawLimit')}
                      label=""
                      onClick={(e) => e.preventDefault()}
                      aria-disabled="true"
                    />
                ...
                <Box className="rounded-lg bg-white px-4 py-4 shadow-soft dark:bg-dark-700 dark:shadow-none sm:px-5">
                  <div className="mt-1.5 flex items-center justify-between">
                    ...
                    <Switch
                      {...register('hasWeeklyWithdrawLimit')}
                      label=""
                      onClick={(e) => e.preventDefault()}
                      aria-disabled="true"
                    />
                ...
                <Box className="rounded-lg bg-white px-4 py-4 shadow-soft dark:bg-dark-700 dark:shadow-none sm:px-5">
                  <div className="mt-1.5 flex items-center justify-between">
                    ...
                    <Switch
                      {...register('hasMonthlyWithdrawLimit')}
                      label=""
                      onClick={(e) => e.preventDefault()}
                      aria-disabled="true"
                    />
