...
import { approvedCommissionColumns } from './columns';
import TableCard from 'components/ui/custom/TableCard';
import useTable from 'components/ui/useTable';
import { t } from 'i18next';

export default function ApprovedCommissionList({ data = [], loading = false }) {
  const title = `${t('last')} ${t('approved')} ${t('commission')} ${t('list')}`;
