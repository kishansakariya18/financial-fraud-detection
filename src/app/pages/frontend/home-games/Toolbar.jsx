  ...
  return (
    <div className="table-toolbar">
      <div
        ...
        <div>
          {hasPermission(PERMISSIONS.FRONTEND.ADD_HOME_GAMES) && (
            <Button
          ...
          {hasPermission(PERMISSIONS.FRONTEND.REORDER_HOME_GAMES) && (
            <Button
