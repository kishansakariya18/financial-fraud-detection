...
import { promocodeListResponseMapper } from '../helper';
...
export default function PromoCodeList() {
  ...
  const fetchDepositPromocodeList = async () => {
    ...
    const apiData = promocodeListResponseMapper(result.response.data);
  ...
  useEffect(() => {
    ...
    if (queryParams.keyword) {
      filtersFromQuery.push({ id: 'promocode', value: queryParams.keyword });
    }
